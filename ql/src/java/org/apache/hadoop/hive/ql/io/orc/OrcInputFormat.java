        ...
        try {
            for (Future<?> pathFuture : pathFutures) {
                ...
                if (splitStrategy instanceof ETLSplitStrategy) {
                    ...
                    UserGroupInformation etlSplitStrategyUgi = etlSplitStrategy.getUgi();
                    UserGroupInformation tpUgi = etlSplitStrategyUgi == null ? UserGroupInformation.getCurrentUser() : etlSplitStrategyUgi;
                    for (SplitInfo splitInfo : splitInfos) {
                        splitFutures.add(context.threadPool.submit(new SplitGenerator(splitInfo, tpUgi)));
                    }
                } else {
